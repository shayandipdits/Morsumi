...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $products = Product::where('is_published',1)->take('3')->get();
        //dd($products);



        return getView('pages.home', ['blogs' => $blogs, 'sliders' => $sliders, 'banner_section_one_banners' => $banner_section_one_banners, 'client_feedback' => $client_feedback, 'products'=>$products]);
    }
    ...
    public function abouth2ion()
    {
        return getView('pages.quickLinks.abouth2ion');
    }
}
