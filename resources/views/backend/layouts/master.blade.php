...
<head>
    ...
    <!--favicon icon-->
    <link rel="shortcut icon" href="{{ staticAsset('uploads/media/aMqP5xW8nVbihzuHFxRSbfcyUaTRg9kuLgU3Dkgj.png') }}">
...
<body>
    ...
    <div id="preloader" class="bg-light-subtle">
        <div class="preloader-wrap">
            <img src="{{ staticAsset('uploads/media/aMqP5xW8nVbihzuHFxRSbfcyUaTRg9kuLgU3Dkgj.png') }}" class="img-fluid">
