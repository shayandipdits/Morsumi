            ...
            <div class="row align-items-center">
                <div class="col-xxl-4 col-xl-3">
                    <div class="topbar-info d-none d-xl-block">
                        <p class="text-white fs-sm fw-medium mb-0">Welcome to Health Matters</p>
                    </div>
                </div>
                <div class="col-xxl-8 col-xl-9">
                    ...
                    <ul
                        ...
                        <li class="nav-item">
                            <a href="mailto:support@healthmatters.org.in">
                                <span class="me-1">
...
@endforeach
    ...
    <div class="gshop-navbar bg-white  ps-lg-5 position-relative">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xxl-2 col-xl-3 col-md-3 col-5">
                    <a href="{{ route('home') }}" class="logo"><img
                            src="{{ staticAsset('uploads/media/LgjL80NXiNxP7Q2zYhGRuKFfpTFxb9JIiQuUlLE3.png') }}"
...
@endforeach
                        ...
                        <nav class="gshop-navmenu ms-3 d-none d-xl-block">
                            <ul class="d-flex align-itmes-center justify-content-end">
                                ...
                                <li><a href="{{ route('home.pages.contactUs') }}">Contact Us</a>
                                </li>
...
@endforeach
                        ...
                        <div
                            ...
                            <a href="tel:033 3544 1899" class="d-flex align-items-center">
                                <span
                                ...
                                <div class="ms-3">
                                    ...
                                    <h6 class="mb-0 mt-1 fs-sm">+(033) 3544 1899</h6>
                                </div>
                            </a>
                        </div>
