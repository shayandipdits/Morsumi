...
<script src="{{ staticAsset('frontend/default/assets/js/vendors/zoomsl.js') }}"></script>
<script src="{{ staticAsset('frontend/default/assets/js/vendors/zoomsl.min.js') }}"></script>
